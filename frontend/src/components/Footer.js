...
const Footer = () => {
    ...
    return (
        <footer className={`${isDark ? 'bg-dark-bg text-gray-300' : 'bg-white text-gray-700'
            } py-8 px-6 mt-8 transition-all duration-200 border-t ${isDark ? 'border-gray-700' : 'border-gray-200'
            } backdrop-blur-sm ${isDark ? 'bg-dark-bg/90' : 'bg-white/90'
            }`}>
                        ...
                        <div className="flex items-center">
                            <div className="group relative flex items-center mx-1">
                                <a
                                    ...
                                    className={`${isDark ? 'text-gray-300 hover:text-primary-purple' : 'text-gray-600 hover:text-primary-purple'
                                ...
                                <span className={`absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs font-medium ${isDark ? 'bg-gray-700 text-white' : 'bg-white text-gray-800'
                                    } rounded shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap pointer-events-none border ${isDark ? 'border-gray-600' : 'border-gray-200'
